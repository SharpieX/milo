var qt=Object.defineProperty;var jt=i=>{throw TypeError(i)};var si=(i,t,e)=>t in i?qt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var ci=(i,t)=>()=>(i&&(t=i(i=0)),t);var li=(i,t)=>{for(var e in t)qt(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>si(i,typeof t!="symbol"?t+"":t,e),ut=(i,t,e)=>t.has(i)||jt("Cannot "+e);var c=(i,t,e)=>(ut(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?jt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),p=(i,t,e,r)=>(ut(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),E=(i,t,e)=>(ut(i,t,"access private method"),e);var Gt=(i,t,e,r)=>({set _(a){p(i,t,a,e)},get _(){return c(i,t,r)}});var ft={};li(ft,{default:()=>W});import{LitElement as di,html as Ke,css as pi}from"../lit-all.min.js";function hi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var W,xt=ci(()=>{W=class extends di{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ke`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
        ></merch-icon>`:Ke`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;return t?hi()?Ke`
    ...
    `);customElements.define("mas-mnemonic",W)});import{LitElement as Da}from"../lit-all.min.js";import{css as Kt,unsafeCSS as Yt}from"../lit-all.min.js";var _="(max-width: 767px)",$="(max-width: 1199px)",b="(min-width: 768px)",u="(min-width: 1200px)",P="(min-width: 1600px)",Vt={matchMobile:window.matchMedia(_),matchDesktop:window.matchMedia(`${u} and (not ${P})`),matchDesktopOrUp:window.matchMedia(u),matchLargeDesktop:window.matchMedia(P),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},A=Vt;function Re(){return Vt.isDesktop}var Wt=Kt`
    :host {
...
`,Qt=()=>[Kt`
      ...
      `];import{LitElement as mi,html as Xt,css as gi}from"../lit-all.min.js";function ui(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var ce=class extends mi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(ui())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>xt())}e.remove()})}render(){let{href:t}=this;return t?Xt`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:Xt` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};l(ce,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(ce,"styles",gi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",ce);var Za=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Ja=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var v='span[is="inline-price"][data-wcs-osi]',q='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var fi='a[is="upt-link"]',Zt=`${v},${q},${fi}`;var Jt="merch-offer-select:ready",er="merch-card:action-menu-toggle";var B="merch-quantity-selector:change",tr="merch-card-quantity:change",bt="merch-modal:addon-and-quantity-update";var vt="merch-card-collection:literals-changed";var le="aem:load",de="aem:error",rr="mas:ready",ir="mas:error",ar="placeholder-failed",nr="placeholder-pending",or="placeholder-resolved";var sr="mas:failed",Me="mas:resolved",cr="mas/commerce";var j="failed",Q="pending",G="resolved";var We="X-Request-Id",en=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var tn=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Qe=":start",Xe=":duration";var lr="legal";var xi="mas-commerce-service";function dr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function k(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function pe(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function pr(){return window.matchMedia("(max-width: 1024px)").matches}function X(){return document.getElementsByTagName(xi)?.[0]}function Ne(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Oe,Z,$e,Ie,he,Ze=class extends HTMLElement{constructor(){super();g(this,Oe,"");g(this,Z);g(this,$e,[]);g(this,Ie,[]);g(this,he);p(this,he,dr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,Z)?this.parentElement.style.borderRadius=c(this,Z):c(this,Z)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,$e).map((r,a)=>{let n=c(this,Ie)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,Oe)}, ${e})`}connectedCallback(){c(this,he).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&p(this,Z,a?.trim()),e==="colors"&&a?p(this,$e,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?p(this,Ie,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&p(this,Oe,a?.trim()??""),c(this,he).call(this)}};Oe=new WeakMap,Z=new WeakMap,$e=new WeakMap,Ie=new WeakMap,he=new WeakMap;customElements.define("merch-gradient",Ze);import{LitElement as bi,html as vi,css as yi}from"../lit-all.min.js";var me=class extends bi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${v}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Me,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Me,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return vi`
            <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};l(me,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),l(me,"styles",yi`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",me);import{html as Je,nothing as wi}from"../lit-all.min.js";var ge,De=class De{constructor(t){l(this,"card");g(this,ge);this.card=t,this.insertVariantStyle()}getContainer(){return p(this,ge,c(this,ge)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,ge)}insertVariantStyle(){if(!De.styleMap[this.card.variant]){De.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Je`
        ...
        `}get cardImage(){return Je` <div class="image">
            ...
            >`:wi}get secureLabelFooter(){return Je`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,e=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||e===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-e-16)}px`)}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return et(this.card.variant)}};ge=new WeakMap,l(De,"styleMap",{});var f=De;import{html as yt,css as Ei}from"../lit-all.min.js";var hr=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return hr}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};l(ue,"variantStyle",Ei`
    ...
    `);import{html as Fe}from"../lit-all.min.js";var gr=`
:root {
...
`;var tt=class extends f{constructor(t){super(t)}getGlobalCSS(){return gr}renderLayout(){return Fe`${this.cardImage}
    <div class="body">
...
`;var rt=class extends f{constructor(t){super(t)}getGlobalCSS(){return ur}renderLayout(){return fr` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":fr`<hr />`} ${this.secureLabelFooter}`}};import{html as fe,css as Si,unsafeCSS as br}from"../lit-all.min.js";var xr=`
  :root {
...
`;var Ai=32,xe=class extends f{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?fe`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),A.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(xe,"variantStyle",Si`
  ...
  `);import{html as Be,css as ki,nothing as it}from"../lit-all.min.js";var vr=`
:root {
...
`;var be=class extends f{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Er}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return wt` ${this.badge}
    ...
    `);import{html as Et,css as Ti}from"../lit-all.min.js";var Sr=`
:root {
...
`;var ve=class extends f{constructor(t){super(t)}getGlobalCSS(){return Sr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Et` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};l(ve,"variantStyle",Ti`
...
`;var kr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ye=class extends f{constructor(t){super(t)}getGlobalCSS(){return Ar}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return St`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?St`
                  ...
                  `:St`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};l(ye,"variantStyle",Li`
...
`;var At={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},we=class extends f{getGlobalCSS(){return Cr}get aemFragmentMapping(){return At}get headingSelector(){return'[slot="heading-xs"]'}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),Re())){let t=this.getContainer();if(!t)return;let e=`--consonant-merch-card-${this.card.variant}`,r=t.style.getPropertyValue(`${e}-description-height`);requestAnimationFrame(r?()=>{this.syncHeights()}:()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(n=>n.variantLayout?.syncHeights?.())})}}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Re()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(Re())t.removeAttribute("data-expanded");else{let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}};e();let r=window.matchMedia($);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia($).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation();let e=this.card;if(!e||Re())return;let n=e.getAttribute("data-expanded")==="true"?"false":"true";e.setAttribute("data-expanded",n)}renderLayout(){return _i`
    ...
    `);import{html as zi,css as Ri}from"../lit-all.min.js";var Tr=`
:root {
...
`;var kt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"l"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},Ee=class extends f{getGlobalCSS(){return Tr}get aemFragmentMapping(){return kt}get headingSelector(){return'[slot="heading-xs"]'}syncHeights(){if(this.card.getBoundingClientRect().width<=2)return;let t=this.card.querySelector('[slot="short-description"]');t&&this.updateCardElementMinHeight(t,"short-description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price");let r=this.card.querySelector('[slot="cta"]');r&&this.updateCardElementMinHeight(r,"cta")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,await Promise.all(this.card.prices.map(t=>t.onceSettled())),window.matchMedia("(min-width: 1025px)").matches)){let t=this.getContainer();if(!t)return;let e=`--consonant-merch-card-${this.card.variant}`,r=t.style.getPropertyValue(`${e}-price-height`);requestAnimationFrame(r?()=>{this.syncHeights()}:()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(n=>n.variantLayout?.syncHeights?.())})}}renderLayout(){return zi`
    ...
    `);import{css as Mi,html as Ni}from"../lit-all.min.js";var Lr=`
...
`;var _r={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Se=class extends f{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Lr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${v}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Ni`
            ${this.badge}
            <div class="body">
...
`;var Ct={backgroundImage:{tag:"div",slot:"image"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},title:{tag:"h2",slot:"heading-m",maxCount:2e3,withSuffix:!0},subtitle:{tag:"p",slot:"heading-xxxs",maxCount:2e3,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},mnemonics:{size:"s"},size:["standard","wide"],borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300",blue:"--spectrum-blue-400"}}},Ae=class extends f{getGlobalCSS(){return Pr}get aemFragmentMapping(){return Ct}renderLayout(){return Oi`
    ...
    `);var nt=new Map,S=(i,t,e=null,r=null,a)=>{nt.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};S("catalog",ue,mr,ue.variantStyle);S("image",tt);S("inline-heading",rt);S("mini-compare-chart",xe,null,xe.variantStyle);S("plans",C,at,C.variantStyle,C.collectionOptions);S("plans-students",C,wr,C.variantStyle,C.collectionOptions);S("plans-education",C,yr,C.variantStyle,C.collectionOptions);S("product",be,null,be.variantStyle);S("segment",ve,null,ve.variantStyle);S("special-offers",ye,kr,ye.variantStyle);S("simplified-pricing-express",we,At,we.variantStyle);S("full-pricing-express",Ee,kt,Ee.variantStyle);S("mini",Se,_r,Se.variantStyle);S("single-card",Ae,Ct,Ae.variantStyle);var Tt=i=>{let t=nt.get(i.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let a=new CSSStyleSheet;a.replaceSync(r.cssText),i.shadowRoot.adoptedStyleSheets.push(a)}catch{let n=document.createElement("style");n.textContent=r.cssText,i.shadowRoot.appendChild(n)}return new e(i)};function et(i){return nt.get(i)?.fragmentMapping}function zr(i){return nt.get(i)?.collectionOptions}var Rr=document.createElement("style");Rr.innerHTML=`
:root {
...
`;document.head.appendChild(Rr);function ot(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=Lt(r)?r:i;n=o.get(s)}if(a&&n==null){let o=Lt(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Di(Lt(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Ii=i=>typeof i=="boolean",st=i=>typeof i=="function";var Lt=i=>typeof i=="string";function Mr(i,t){if(Ii(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Di(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var J=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(We);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Fi="mas-commerce-service",Bi={requestId:We,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ct=i=>window.setTimeout(i);function _t(){return document.getElementsByTagName(Fi)?.[0]}function Nr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(Bi)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Or(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var $r="fragment",Ir="author",Dr="preview",Fr="loading",Br="timeout",Pt="aem-fragment",Hr="eager",Ur="cache",Hi=[Hr,Ur],I,ee,M,zt=class{constructor(){g(this,I,new Map);g(this,ee,new Map);g(this,M,new Map)}clear(){c(this,I).clear(),c(this,ee).clear(),c(this,M).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,I).set(t.id,t),t.fields?.originalId&&c(this,I).set(t.fields.originalId,t),c(this,M).has(t.id)){let[,r]=c(this,M).get(t.id);r()}if(c(this,M).has(t.fields?.originalId)){let[,r]=c(this,M).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,I).has(t)}entries(){return c(this,I).entries()}get(t){return c(this,I).get(t)}getAsPromise(t){let[e]=c(this,M).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,M).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ee).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ee).set(t,e)),e}remove(t){c(this,I).delete(t),c(this,ee).delete(t),c(this,M).delete(t)}};I=new WeakMap,ee=new WeakMap,M=new WeakMap;var V=new zt,ke,D,H,z,T,y,He,Ue,N,qe,je,Ce,O,qr,jr,Rt,Gr,lt=class extends HTMLElement{constructor(){super(...arguments);g(this,O);l(this,"cache",V);g(this,ke);g(this,D,null);g(this,H,null);g(this,z,null);g(this,T);g(this,y);g(this,He,Hr);g(this,Ue,5e3);g(this,N);g(this,qe,!1);g(this,je,0);g(this,Ce)}static get observedAttributes(){return[$r,Fr,Br,Ir,Dr]}attributeChangedCallback(e,r,a){e===$r&&(p(this,T,a),p(this,y,V.getFetchInfo(a))),e===Fr&&Hi.includes(a)&&p(this,He,a),e===Br&&p(this,Ue,parseInt(a,10)),e===Ir&&p(this,qe,["","true"].includes(a)),e===Dr&&p(this,Ce,a)}connectedCallback(){if(!c(this,N)){if(c(this,z)??p(this,z,X(this)),p(this,Ce,c(this,z).settings?.preview),c(this,ke)??p(this,ke,c(this,z).log.module(`${Pt}[${c(this,T)}]`)),!c(this,T)||c(this,T)==="#"){c(this,y)??p(this,y,V.getFetchInfo("missing-fragment-id")),E(this,O,Rt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,N)&&!await Promise.race([c(this,N),Promise.resolve(!1)]))return;e&&V.remove(c(this,T)),c(this,He)===Ur&&await Promise.race([V.getAsPromise(c(this,T)),new Promise(s=>setTimeout(s,c(this,Ue)))]);try{p(this,N,E(this,O,Gr).call(this)),await c(this,N)}catch(s){return E(this,O,Rt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,D)||{};return o&&!ot("mas.disableWcsCache")&&c(this,z).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(le,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,y)},bubbles:!0,composed:!0})),c(this,N)}get updateComplete(){return c(this,N)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,H)?c(this,H):(c(this,qe)?this.transformAuthorData():this.transformPublishData(),c(this,H))}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,D);p(this,H,e.reduce((h,{name:m,multiple:x,values:L})=>(h.fields[m]=x?L:L[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,D);p(this,H,Object.entries(e).reduce((h,[m,x])=>(h.fields[m]=x?.mimeType?x.value:x??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,T),{locale:c(this,z).settings.locale,apiKey:c(this,z).settings.wcsApiKey})}};ke=new WeakMap,D=new WeakMap,H=new WeakMap,z=new WeakMap,T=new WeakMap,y=new WeakMap,He=new WeakMap,Ue=new WeakMap,N=new WeakMap,qe=new WeakMap,je=new WeakMap,Ce=new WeakMap,O=new WeakSet,qr=async function(e){Gt(this,je)._++;let r=`${Pt}:${c(this,T)}:${c(this,je)}`,a=`${r}${Qe}`,n=`${r}${Xe}`;if(c(this,Ce))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,y).stale=!1,c(this,y).url=e,o=await Or(e,{cache:"default",credentials:"omit"}),E(this,O,jr).call(this,o),c(this,y).status=o?.status,c(this,y).measure=pe(performance.measure(n,a)),c(this,y).retryCount=o.retryCount,!o?.ok)throw new J("Unexpected fragment response",{response:o,...c(this,z).duration});return await o.json()}catch(s){if(c(this,y).measure=pe(performance.measure(n,a)),c(this,y).retryCount=s.retryCount,c(this,D))return c(this,y).stale=!0,c(this,ke).error("Serving stale data",c(this,y)),c(this,D);let d=s.message??"unknown";throw new J(`Failed to fetch fragment: ${d}`,{})}},jr=function(e){Object.assign(c(this,y),Nr(e))},Rt=function(e){p(this,N,null),c(this,y).message=e,this.classList.add("error");let r={...c(this,y),...c(this,z).duration};c(this,ke).error(e,r),this.dispatchEvent(new CustomEvent(de,{detail:r,bubbles:!0,composed:!0}))},Gr=async function(){var d;this.classList.remove("error"),p(this,H,null);let e=V.get(c(this,T));if(e)return p(this,D,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,z).settings,s=`${r}/fragment?id=${c(this,T)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await E(this,O,qr).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,T)),V.add(e),p(this,D,e),!0},l(lt,"cache",V);customElements.define(Pt,lt);import{LitElement as Ui,html as qi,css as ji}from"../lit-all.min.js";var Te=class extends Ui{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return qi`<div class="badge">
            ${this.text}
        </div>`}};l(Te,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),l(Te,"styles",ji`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Te);import{html as Gi,css as Vi,LitElement as Yi}from"../lit-all.min.js";var Ge=class extends Yi{constructor(){super()}render(){return Gi`
            <slot name="icon"></slot>
