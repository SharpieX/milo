var jt=Object.defineProperty;var Gt=i=>{throw TypeError(i)};var si=(i,t,e)=>t in i?jt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var ci=(i,t)=>()=>(i&&(t=i(i=0)),t);var li=(i,t)=>{for(var e in t)jt(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>si(i,typeof t!="symbol"?t+"":t,e),ft=(i,t,e)=>t.has(i)||Gt("Cannot "+e);var c=(i,t,e)=>(ft(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Gt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),p=(i,t,e,r)=>(ft(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),E=(i,t,e)=>(ft(i,t,"access private method"),e);var Vt=(i,t,e,r)=>({set _(a){p(i,t,a,e)},get _(){return c(i,t,r)}});var xt={};li(xt,{default:()=>K});import{LitElement as di,html as We,css as pi}from"../lit-all.min.js";function hi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var K,bt=ci(()=>{K=class extends di{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?We`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
        ></merch-icon>`:We`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;return t?hi()?We`
    ...
    `);customElements.define("mas-mnemonic",K)});import{LitElement as Da}from"../lit-all.min.js";import{css as Kt,unsafeCSS as Yt}from"../lit-all.min.js";var L="(max-width: 767px)",N="(max-width: 1199px)",b="(min-width: 768px)",u="(min-width: 1200px)",O="(min-width: 1600px)";function Ve(){return window.matchMedia(L)}function Ye(){return window.matchMedia(u)}function Ke(){return Ve().matches}function F(){return Ye().matches}var Wt=Kt`
    :host {
...
`,Xt=()=>[Kt`
      ...
      `];import{LitElement as mi,html as Qt,css as gi}from"../lit-all.min.js";function ui(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var se=class extends mi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(ui())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>bt())}e.remove()})}render(){let{href:t}=this;return t?Qt`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:Qt` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};l(se,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(se,"styles",gi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",se);var Za=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Ja=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var v='span[is="inline-price"][data-wcs-osi]',U='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var fi='a[is="upt-link"]',Zt=`${v},${U},${fi}`;var Jt="merch-offer-select:ready",er="merch-card:action-menu-toggle";var vt="merch-quantity-selector:change",tr="merch-card-quantity:change",yt="merch-modal:addon-and-quantity-update";var ce="aem:load",le="aem:error",rr="mas:ready",ir="mas:error",ar="placeholder-failed",nr="placeholder-pending",or="placeholder-resolved";var sr="mas:failed",ze="mas:resolved",cr="mas/commerce";var q="failed",W="pending",j="resolved";var Xe="X-Request-Id",en=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var tn=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Qe=":start",Ze=":duration";var lr="legal";var xi="mas-commerce-service";function dr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function A(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function de(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function pr(){return window.matchMedia("(max-width: 1024px)").matches}function X(){return document.getElementsByTagName(xi)?.[0]}function Re(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Me,Q,Ne,Oe,pe,Je=class extends HTMLElement{constructor(){super();g(this,Me,"");g(this,Q);g(this,Ne,[]);g(this,Oe,[]);g(this,pe);p(this,pe,dr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,Q)?this.parentElement.style.borderRadius=c(this,Q):c(this,Q)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Ne).map((r,a)=>{let n=c(this,Oe)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,Me)}, ${e})`}connectedCallback(){c(this,pe).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&p(this,Q,a?.trim()),e==="colors"&&a?p(this,Ne,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?p(this,Oe,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&p(this,Me,a?.trim()??""),c(this,pe).call(this)}};Me=new WeakMap,Q=new WeakMap,Ne=new WeakMap,Oe=new WeakMap,pe=new WeakMap;customElements.define("merch-gradient",Je);import{LitElement as bi,html as vi,css as yi}from"../lit-all.min.js";var he=class extends bi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${v}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(ze,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(ze,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return vi`
            <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};l(he,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),l(he,"styles",yi`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",he);import{html as et,nothing as wi}from"../lit-all.min.js";var me,$e=class $e{constructor(t){l(this,"card");g(this,me);this.card=t,this.insertVariantStyle()}getContainer(){return p(this,me,c(this,me)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,me)}insertVariantStyle(){if(!$e.styleMap[this.card.variant]){$e.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),et`
        ...
        `}get cardImage(){return et` <div class="image">
            ...
            >`:wi}get secureLabelFooter(){return et`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,e=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||e===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-e-16)}px`)}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return tt(this.card.variant)}};me=new WeakMap,l($e,"styleMap",{});var f=$e;import{html as wt,css as Ei}from"../lit-all.min.js";var hr=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return hr}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};l(ge,"variantStyle",Ei`
    ...
    `);import{html as Ie}from"../lit-all.min.js";var gr=`
:root {
...
`;var rt=class extends f{constructor(t){super(t)}getGlobalCSS(){return gr}renderLayout(){return Ie`${this.cardImage}
    <div class="body">
...
`;var it=class extends f{constructor(t){super(t)}getGlobalCSS(){return ur}renderLayout(){return fr` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":fr`<hr />`} ${this.secureLabelFooter}`}};import{html as ue,css as Si,unsafeCSS as br}from"../lit-all.min.js";var xr=`
  :root {
...
`;var Ai=32,fe=class extends f{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?ue`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),Ke()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(fe,"variantStyle",Si`
  ...
  `);import{html as De,css as ki,nothing as at}from"../lit-all.min.js";var vr=`
:root {
...
`;var nt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},yr={...function(){let{whatsIncluded:i,size:t,...e}=nt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},wr={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...a}=nt;return a}()},k=class extends f{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===lr&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return vr}adjustSlotPlacement(t,e,r){let a=this.card.shadowRoot,n=a.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=a.querySelector(`footer slot[name="${t}"]`),d=a.querySelector(`.body slot[name="${t}"]`),h=a.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),s&&s.remove()),!!e.includes(o)){if(n?.classList.toggle("wide-footer",F()),!r&&s){if(d)s.remove();else{let m=h.querySelector(`[data-placeholder-for="${t}"]`);m?m.replaceWith(s):h.appendChild(s)}return}if(r&&d){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",t),m.classList.add("slot-placeholder"),!s){let x=d.cloneNode(!0);n.prepend(x)}d.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],F()),this.adjustSlotPlacement("callout-content",["super-wide"],F())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("ul");if(!r)return;let a=r.previousElementSibling,n=document.createElement("div");n.classList.add("spacer"),e.insertBefore(n,a);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let d=0,h=this.card.querySelector('[slot="heading-s"]');h&&(d+=Re(h));let m=this.card.querySelector('[slot="subtitle"]');m&&(d+=Re(m));let x=this.card.querySelector('[slot="heading-m"]');x&&(d+=8+Re(x));for(let oe of e.childNodes){if(oe.classList.contains("spacer"))break;d+=Re(oe)}let T=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(T)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${v}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?De`<div class="divider"></div>`:at}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],e=this.card.querySelector(`[slot="heading-m"] ${v}[data-template="price"]`);e&&t.push(e);let r=t.map(async a=>{let n=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),a.parentNode.insertBefore(n,a.nextSibling),await n.onceSettled())});await Promise.all(r)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?De`<label id="stock-checkbox">
    ...
    `),l(k,"collectionOptions",{customHeaderArea:t=>t.sidenav?De`<slot name="resultsText"></slot>`:at,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as Et,css as Ci}from"../lit-all.min.js";var Er=`
:root {
...
`;var xe=class extends f{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Er}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Et` ${this.badge}
    ...
    `);import{html as St,css as Ti}from"../lit-all.min.js";var Sr=`
:root {
...
`;var be=class extends f{constructor(t){super(t)}getGlobalCSS(){return Sr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return St` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};l(be,"variantStyle",Ti`
  ...
  `);import{html as At,css as Li}from"../lit-all.min.js";var Ar=`
:root {
...
`;var kr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ve=class extends f{constructor(t){super(t)}getGlobalCSS(){return Ar}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return At`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?At`
                  ...
                  `:At`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};l(ve,"variantStyle",Li`
...
`;var Tt={backgroundImage:{tag:"div",slot:"image"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},title:{tag:"h2",slot:"heading-m",maxCount:2e3,withSuffix:!0},subtitle:{tag:"p",slot:"heading-xxxs",maxCount:2e3,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},mnemonics:{size:"s"},size:["standard","wide"],borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300",blue:"--spectrum-blue-400"}}},Se=class extends f{getGlobalCSS(){return Pr}get aemFragmentMapping(){return Tt}renderLayout(){return Oi`
    ...
    `);var ot=new Map,S=(i,t,e=null,r=null,a)=>{ot.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};S("catalog",ge,mr,ge.variantStyle);S("image",rt);S("inline-heading",it);S("mini-compare-chart",fe,null,fe.variantStyle);S("plans",k,nt,k.variantStyle,k.collectionOptions);S("plans-students",k,wr,k.variantStyle,k.collectionOptions);S("plans-education",k,yr,k.variantStyle,k.collectionOptions);S("product",xe,null,xe.variantStyle);S("segment",be,null,be.variantStyle);S("special-offers",ve,kr,ve.variantStyle);S("simplified-pricing-express",ye,kt,ye.variantStyle);S("full-pricing-express",we,Ct,we.variantStyle);S("mini",Ee,_r,Ee.variantStyle);S("single-card",Se,Tt,Se.variantStyle);var Lt=i=>{let t=ot.get(i.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let a=new CSSStyleSheet;a.replaceSync(r.cssText),i.shadowRoot.adoptedStyleSheets.push(a)}catch{let n=document.createElement("style");n.textContent=r.cssText,i.shadowRoot.appendChild(n)}return new e(i)};function tt(i){return ot.get(i)?.fragmentMapping}function zr(i){return ot.get(i)?.collectionOptions}var Rr=document.createElement("style");Rr.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var Fi="mas-commerce-service",Bi={requestId:Xe,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var lt=i=>window.setTimeout(i);function Pt(){return document.getElementsByTagName(Fi)?.[0]}function Nr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(Bi)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Or(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var $r="fragment",Ir="author",Dr="preview",Fr="loading",Br="timeout",zt="aem-fragment",Hr="eager",Ur="cache",Hi=[Hr,Ur],$,J,z,Rt=class{constructor(){g(this,$,new Map);g(this,J,new Map);g(this,z,new Map)}clear(){c(this,$).clear(),c(this,J).clear(),c(this,z).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,$).set(t.id,t),t.fields?.originalId&&c(this,$).set(t.fields.originalId,t),c(this,z).has(t.id)){let[,r]=c(this,z).get(t.id);r()}if(c(this,z).has(t.fields?.originalId)){let[,r]=c(this,z).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,$).has(t)}entries(){return c(this,$).entries()}get(t){return c(this,$).get(t)}getAsPromise(t){let[e]=c(this,z).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,z).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,J).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,J).set(t,e)),e}remove(t){c(this,$).delete(t),c(this,J).delete(t),c(this,z).delete(t)}};$=new WeakMap,J=new WeakMap,z=new WeakMap;var G=new Rt,Ae,I,B,_,C,y,Fe,Be,R,He,Ue,ke,M,qr,jr,Mt,Gr,dt=class extends HTMLElement{constructor(){super(...arguments);g(this,M);l(this,"cache",G);g(this,Ae);g(this,I,null);g(this,B,null);g(this,_,null);g(this,C);g(this,y);g(this,Fe,Hr);g(this,Be,5e3);g(this,R);g(this,He,!1);g(this,Ue,0);g(this,ke)}static get observedAttributes(){return[$r,Fr,Br,Ir,Dr]}attributeChangedCallback(e,r,a){e===$r&&(p(this,C,a),p(this,y,G.getFetchInfo(a))),e===Fr&&Hi.includes(a)&&p(this,Fe,a),e===Br&&p(this,Be,parseInt(a,10)),e===Ir&&p(this,He,["","true"].includes(a)),e===Dr&&p(this,ke,a)}connectedCallback(){if(!c(this,R)){if(c(this,_)??p(this,_,X(this)),p(this,ke,c(this,_).settings?.preview),c(this,Ae)??p(this,Ae,c(this,_).log.module(`${zt}[${c(this,C)}]`)),!c(this,C)||c(this,C)==="#"){c(this,y)??p(this,y,G.getFetchInfo("missing-fragment-id")),E(this,M,Mt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,R)&&!await Promise.race([c(this,R),Promise.resolve(!1)]))return;e&&G.remove(c(this,C)),c(this,Fe)===Ur&&await Promise.race([G.getAsPromise(c(this,C)),new Promise(s=>setTimeout(s,c(this,Be)))]);try{p(this,R,E(this,M,Gr).call(this)),await c(this,R)}catch(s){return E(this,M,Mt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,I)||{};return o&&!st("mas.disableWcsCache")&&c(this,_).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ce,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,y)},bubbles:!0,composed:!0})),c(this,R)}get updateComplete(){return c(this,R)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,B)?c(this,B):(c(this,He)?this.transformAuthorData():this.transformPublishData(),c(this,B))}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,I);p(this,B,e.reduce((h,{name:m,multiple:x,values:T})=>(h.fields[m]=x?T:T[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,I);p(this,B,Object.entries(e).reduce((h,[m,x])=>(h.fields[m]=x?.mimeType?x.value:x??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,C),{locale:c(this,_).settings.locale,apiKey:c(this,_).settings.wcsApiKey})}};Ae=new WeakMap,I=new WeakMap,B=new WeakMap,_=new WeakMap,C=new WeakMap,y=new WeakMap,Fe=new WeakMap,Be=new WeakMap,R=new WeakMap,He=new WeakMap,Ue=new WeakMap,ke=new WeakMap,M=new WeakSet,qr=async function(e){Vt(this,Ue)._++;let r=`${zt}:${c(this,C)}:${c(this,Ue)}`,a=`${r}${Qe}`,n=`${r}${Ze}`;if(c(this,ke))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,y).stale=!1,c(this,y).url=e,o=await Or(e,{cache:"default",credentials:"omit"}),E(this,M,jr).call(this,o),c(this,y).status=o?.status,c(this,y).measure=de(performance.measure(n,a)),c(this,y).retryCount=o.retryCount,!o?.ok)throw new Z("Unexpected fragment response",{response:o,...c(this,_).duration});return await o.json()}catch(s){if(c(this,y).measure=de(performance.measure(n,a)),c(this,y).retryCount=s.retryCount,c(this,I))return c(this,y).stale=!0,c(this,Ae).error("Serving stale data",c(this,y)),c(this,I);let d=s.message??"unknown";throw new Z(`Failed to fetch fragment: ${d}`,{})}},jr=function(e){Object.assign(c(this,y),Nr(e))},Mt=function(e){p(this,R,null),c(this,y).message=e,this.classList.add("error");let r={...c(this,y),...c(this,_).duration};c(this,Ae).error(e,r),this.dispatchEvent(new CustomEvent(le,{detail:r,bubbles:!0,composed:!0}))},Gr=async function(){var d;this.classList.remove("error"),p(this,B,null);let e=G.get(c(this,C));if(e)return p(this,I,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,_).settings,s=`${r}/fragment?id=${c(this,C)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await E(this,M,qr).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,C)),G.add(e),p(this,I,e),!0},l(dt,"cache",G);customElements.define(zt,dt);import{LitElement as Ui,html as qi,css as ji}from"../lit-all.min.js";var Ce=class extends Ui{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return qi`<div class="badge">
    ...
    `);customElements.define("merch-badge",Ce);import{html as Gi,css as Vi,LitElement as Yi}from"../lit-all.min.js";var qe=class extends Yi{constructor(){super()}render(){return Gi`
            <slot name="icon"></slot>
    ...
    `),l(qe,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",qe);import{html as Nt,css as Ki,LitElement as Wi}from"../lit-all.min.js";var je=class extends Wi{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Nt`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?Nt`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Nt``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};l(je,"styles",Ki`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
